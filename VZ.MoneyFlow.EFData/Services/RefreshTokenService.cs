...
namespace VZ.MoneyFlow.EFData.Services
{
    public class RefreshTokenService : IRefreshTokenService
    {
        ...
        public RefreshTokenService(AppDbContext context, IOptionsMonitor<JwtConfig> options, UserManager<IdentityUser> userManager,
            RoleManager<IdentityRole> roleManager, TokenValidationParameters tokenValidationParameters, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<ResponseAuthResultDto> GenerateJwtToken(IdentityUser user)
        {
            ...
            var tokenDesctiptor = new SecurityTokenDescriptor()
            {
                ...
                Expires = DateTime.UtcNow.AddMinutes(Convert.ToInt32(_configuration["JwtConfig:DurationInMinutesForT"])),
            ...
            var refreshToken = new RefreshToken()
            {
                ...
                ExpiryTime = DateTime.UtcNow.AddMinutes(Convert.ToInt32(_configuration["JwtConfig:DurationInMinutesForRT"])),
